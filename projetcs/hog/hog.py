...
def roll_dice(num_rolls, dice=six_sided):
    ...
    def calculate_score(outcomes):
        if 1 in outcomes:
            return 1
        return sum(outcomes)
    return calculate_score(outcomes)
    # END PROBLEM 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            this_score0 = take_turn(num_rolls0,score1,dice)
            score0 += this_score0
            if feral_hogs and abs(num_rolls0 - last_score0) == 2:
                score0 += 3
            if is_swap(score0,score1):
                score0,score1 = score1, score0
            last_score0 = this_score0
        else:
            num_rolls1 = strategy1(score1,score0)
            this_score1 = take_turn(num_rolls1,score0,dice)
            score1 += this_score1
            if feral_hogs and abs(num_rolls1 - last_score1) == 2:
                score1 += 3
            if is_swap(score1,score0):
                score0,score1 = score1, score0
            last_score1 = this_score1
        who = other(who)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    highest_average_score,highest_average_score_dice_number = 0,1
    for dice_number in range(1,11):
        score = make_averaged(roll_dice,trials_count)(dice_number,dice)
        #print("score: ",score,"index: ",dice_number)
        if score > highest_average_score:
            highest_average_score,highest_average_score_dice_number = score,dice_number
        if score == highest_average_score:
            highest_average_score_dice_number = min(highest_average_score_dice_number,dice_number)
    return highest_average_score_dice_number
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    bacon_score = free_bacon(opponent_score)
    score += bacon_score
    should_swap = is_swap(score, opponent_score)
    if should_swap:
